...
AFountain::AFountain()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh>
		SM_Body01(TEXT("/Game/InfinityBladeGrassLands/Environments/Plains/Env_Plains_Ruins/StaticMesh/SM_Plains_Castle_Fountain_01.SM_Plains_Castle_Fountain_01"));

	if (SM_Body01.Succeeded())
	{
		Body->SetStaticMesh(SM_Body01.Object);
	}
